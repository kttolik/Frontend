...
describe('add', () => {
    test('Should add number', () => {
        expect((() => {
            const testList = new AList([]);
            testList.add(1);
            return testList.toArray()})()).toEqual([1])
    })
});
...
describe('get', () => {
    test('Get element with index 2', () => {
        const testList = new AList([1, 2, 3]);
        expect(testList.get(2)).toEqual(3)
    })
});
...
describe('toString', () => {
    test('Return string', () => {
        const testList = new AList([11, 31, 43]);
...
describe('minValue', () => {
    test('Return min value', () => {
        const testList = new AList([-23, 0, 4, 17]);
...
describe('removeAll', () => {
    test('Remove num', () => {
        const testList = new AList([1, 2, 3, 4])
        expect((() => {
